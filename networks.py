...
class GeneratorBIG(nn.Module):
    def __init__(self,n_inputs=1,n_angles=1):
        ...
        self.conv_final = nn.Conv1d(128,n_angles,kernel_size=3,stride=1, padding=1,bias=True)
...
class GeneratorBIG2(nn.Module):
    def __init__(self,n_inputs=1,n_angles=1):
        super(GeneratorBIG2, self).__init__()
        self.conv1 = nn.Conv1d(n_inputs,256,kernel_size=3,stride=1,padding=1, bias=True)
        self.relu = nn.ReLU(True)
        self.conv2 = nn.Conv1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)
        self.conv3 = nn.Conv1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)
        self.conv4 = nn.Conv1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)
        self.conv5 = nn.Conv1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)

        self.conv6 = nn.Conv1d(256,256,kernel_size=4,stride=1, padding=0,bias=True)
        self.deconv1 = nn.ConvTranspose1d(256,256,kernel_size=4,stride=1, padding=0,bias=True)

        self.deconv2 = nn.ConvTranspose1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)
        self.deconv3 = nn.ConvTranspose1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)
        self.deconv4 = nn.ConvTranspose1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)
        self.deconv5 = nn.ConvTranspose1d(256,256,kernel_size=3,dilation=3,stride=1, padding=1,bias=True)

        self.conv1d = nn.Conv1d(256,256,kernel_size=3,stride=1, padding=1,bias=True)
        self.conv2d = nn.Conv1d(256,256,kernel_size=3,stride=1, padding=1,bias=True)
        self.conv3d = nn.Conv1d(256,256,kernel_size=3,stride=1, padding=1,bias=True)
        self.conv4d = nn.Conv1d(256,256,kernel_size=3,stride=1, padding=1,bias=True)
        self.conv5d = nn.Conv1d(256,256,kernel_size=3,stride=1, padding=1,bias=True)
        self.conv_final = nn.Conv1d(256,n_angles,kernel_size=3,stride=1, padding=1,bias=True)
...
class GeneratorBIG3(nn.Module):
    def __init__(self,n_inputs=1,n_angles=1):
        super(GeneratorBIG3, self).__init__()
